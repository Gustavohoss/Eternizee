            ...
            {selectedTheme === 'instagram' ? (
              ...
              <div className="w-full min-h-full flex flex-col items-center pt-8 px-5 gap-6">
                ...
                >
                  ...
                  {titlePosition === 'bottom' && <div className="w-full text-center mt-4"><span style={titleStyle} className="text-[32px] block px-2 tracking-[1px] leading-relaxed break-words">{pageTitle || "Seu Nome"}</span></div>}
                </div>
                {date && (
